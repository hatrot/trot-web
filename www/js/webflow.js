...
Webflow.require('ix').init([
  {"slug":"nav-display-none","name":"Nav Display None","value":{"style":{"display":"none","opacity":0},"triggers":[]}},
  {"slug":"show-fixed-nav","name":"Show Fixed Nav","value":{"style":{},"triggers":[{"type":"scroll","selector":".header","offsetBot":"15%","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}}
]);
